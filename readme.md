...
Глобальные настройки(на все проекты):
```
git config --global user.name "Your Name" # указать имя, которым будут подписаны коммиты
git config --global user.email "e@w.com"  # указать электропочту, которая будет в описании коммитера
```
Также можно уставить настройки на один проект. Локальные настройки проекта приоритетнее глобальных настроек.
(Команда вводится в корне проекта)
```
git config user.name "Ivanov Ivan" # указать имя, которым будут подписаны коммиты
git config user.email "I.I@www.com"  # указать электропочту, которая будет в описании коммитера
```
